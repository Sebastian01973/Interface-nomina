...
public class JModelComboBox extends JComboBox<Object>{
	...
	public static class propieties extends BasicComboBoxUI{
		...
		public void paintCurrentValueBackground(Graphics g, Rectangle bounds, boolean hasFocus) {
			g.setColor(Constant.COLOR_COMBO_BOX);
		...
		protected ListCellRenderer createRenderer() {
			...
			return new DefaultListCellRenderer() {
				...
				public Component getListCellRendererComponent(JList<?> list, Object value, int index,
					 ...
					 list.setSelectionBackground(Constant.COLOR_COMBO_BOX);
					 
					 if (index !=- 1) {
						setIcon(new ImageIcon(getClass().getResource(Constant.IMG_ARROW_RIGHT)));
					 }
					 return this;
				}
			};
